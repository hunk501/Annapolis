                ...
                success: function(result){
                    ...
                    if(result && result.total) {
                        ...
                        for(var x=0; x < application.length; x++) {                            
                            ...
                            _div += "<a href='#' app_id='"+ application[x]['id'] +"' class='btn btn-primary btn-xs view_rec_modal' title='View'><i class='fa fa-info-circle'></i> View</a> &nbsp;&nbsp; ";
							...
							_div += "<a href='#' app_id='"+ application[x]['id'] +"' class='btn btn-danger btn-xs remv_rec' title='Delete'><i class='fa fa-trash-o'></i> Delete</a></td></tr>";
                            lop++;
                        }
                        _div += "</tbody></table>";
                    }
